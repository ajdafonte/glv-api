...
public class Order
{
    ...
    public Order withId(final String id)
    {
        this.id = id;
        return this;
    }
    ...
    public Order withFood(final Boolean food)
    {
        this.food = food;
        return this;
    }
    ...
    public Order withVip(final Boolean vip)
    {
        this.vip = vip;
        return this;
    }
    ...
    public Order withPickup(final Location pickup)
    {
        this.pickup = pickup;
        return this;
    }
    ...
    public Order withDelivery(final Location delivery)
    {
